...
// ADDED: AI PPT Generator routes (/api/ppt) ✅
// ============================================================
...
const pptRoutes = require("./routes/ppt"); // 🆕 AI PPT Generator
...
// FIX: pehle ye route DO baar mount tha — duplicate hata diya (ek baar kaafi hai)
app.use("/api/question-banks", questionBankRoutes);
app.use("/api/bank-status", questionBankRoutes);
app.use("/api/ppt", pptRoutes); // 🆕 AI PPT Generator
...
app.get("/", (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      "GET /api/owner/audit",
      "POST /api/ppt/generate          — 🆕 AI PPT Generator",
      "GET  /api/ppt/my                — 🆕 My PPTs history",
      "GET  /api/ppt/download/:name    — 🆕 Safe PPT download",
      // 💬 ALEX Chat
...
app.listen(PORT, () => {
  ...
  console.log(`📊 PPT API:      http://localhost:${PORT}/api/ppt/generate`);
});
